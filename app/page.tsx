...
export default function Home() {
  ...
  useEffect(() => {
    const fetchListings = async () => {
      ...
      // 3) Trier VIP d'abord, puis created_at DESC
      ...
      // 4) Enrichir avec isVip pour l'affichage
      ...
      {isSearchOpen && (
        <div className="fixed inset-0 bg-white dark:bg-gray-900 z-[3000] p-4 animate-in slide-in-from-bottom-10 duration-200">
          ...
          <div className="mt-16 max-w-lg mx-auto">
            ...
            />
            <button onClick={handleSearch} className="w-full mt-8 bg-rose-500 text-white font-bold py-3.5 rounded-xl text-lg">
              Rechercher
            </button>
          </div>
        </div>
